        ...
        <img class="w-full h-96 object-cover" 
         ...
         alt="Imagen de la Cancha: <?php echo htmlspecialchars($fila['nombre_cancha'] ?? 'Nombre de la Cancha'); ?>">
            ...
            <div class="md:w-1/2 p-8 flex flex-col justify-between">
                ...
                <div class="mt-8">
                    <a href="reservar.php?id=<?php echo htmlspecialchars($fila['id_cancha'] ?? ''); ?>" class="btn-reserve w-full text-center py-3 px-6 rounded-lg text-white font-bold text-lg hover:shadow-lg focus:outline-none focus:ring-4 focus:ring-green-300">
                        Reservar Ahora
                    </a>
                </div>
            </div>
