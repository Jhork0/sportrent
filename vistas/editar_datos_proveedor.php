<?php include '../logica/cargardatos_proveedor.php'; ?>
...
<head>
    <meta charset="UTF-8">
    <title>Editar Perfil del Proveedor - SportRent</title>
...
<body class="min-h-screen bg-gray-100 font-[Inter] flex flex-col">
    ...
    <main class="flex-grow container mx-auto px-4 py-8">
        <div class="bg-white shadow-xl rounded-xl p-8 max-w-3xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-800 mb-6">Editar Perfil del Proveedor</h1>
            ...
            <form action="../logica/actualizar_proveedor.php" method="POST" class="space-y-6">
                <!-- Datos personales -->
                <div class="grid md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="primer_nombre" required 
                               value="<?php echo htmlspecialchars($proveedor['primer_nombre'] ?? ''); ?>" 
